    ...
    <div class="flex flex-col md:flex-row h-[calc(100vh-64px)] bg-white overflow-hidden relative">
        ...
        <div class="md:hidden p-4 bg-white border-b flex justify-between items-center z-20 shadow-sm relative">
            ...
            <button id="mobile-toggle-btn"
                class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-xl text-sm font-semibold transition-colors shadow-md shadow-blue-200">
                Xem bản đồ GIS
            </button>
        </div>
        ...
        <div id="sidebar"
            class="w-full md:w-[40%] lg:w-[35%] h-full bg-gray-50/50 overflow-y-auto flex flex-col transition-all duration-300 relative z-10 border-r border-gray-200">
            <!-- Header Sidebar -->
            <div class="p-6 sticky top-0 bg-white/80 backdrop-blur-md z-20 border-b border-gray-100 shadow-sm">
                ...
                <div class="flex items-center gap-2 mt-2 mb-4">
                    ...
                    <p class="text-gray-600 text-sm">Tìm thấy <span id="room-count"
                            class="font-bold text-blue-600 text-base">{{ count($ds_goi_y ?? []) }}</span> phòng phù hợp</p>
                </div>
                ...
                <form id="filter-form" onsubmit="return false;" class="flex flex-col gap-3 text-sm">
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="diadiem" placeholder="Nhập địa điểm, trường đại học..."
                            class="flex-1 bg-gray-50 border border-gray-200 text-gray-700 py-2 px-3 rounded-lg focus:ring-blue-500 focus:border-blue-500 outline-none transition-all">
                        <button type="button" id="btn-search-location"
                            class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-colors shadow-sm">
                            Tìm
                        </button>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <select name="ban_kinh"
                            class="bg-gray-50 border border-gray-200 text-gray-700 py-1.5 px-3 rounded-lg focus:ring-blue-500 focus:border-blue-500 outline-none transition-all">
                        ...
                        <label
                            class="flex items-center gap-2 cursor-pointer bg-blue-50 text-blue-700 border border-blue-200 py-1.5 px-3 rounded-lg hover:bg-blue-100 transition-colors">
        ...
        <div id="map-container" class="w-full md:w-[60%] lg:w-[65%] h-full relative z-0">
            ...
            <button id="recenter-btn"
                class="absolute bottom-6 right-6 z-[400] bg-white p-3 rounded-full shadow-lg hover:bg-gray-50 transition-colors border border-gray-200 text-gray-700"
...
@push('scripts')
    ...
    <style>
        ...
        .custom-popup .leaflet-popup-tip-container {
            display: none;
            /* Giấu mũi tên nhọn bên dưới cho hiện đại */
        }
    </style>
@endpush